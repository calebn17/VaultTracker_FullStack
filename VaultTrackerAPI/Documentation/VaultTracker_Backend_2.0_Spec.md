...
> **Purpose:** AI-agent consumable spec for evolving the FastAPI backend from a simple CRUD API into a smart service layer. Read the [Backend Context](Vault%20Tracker%20-%20Backend%20Context.md) first for current state.
