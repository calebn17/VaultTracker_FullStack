...
//  VaultTracker
//
//  Coordinates online reads/writes and SwiftData read-through caches for Home dashboard data.
...
@MainActor
final class TransactionRepository: ObservableObject, TransactionRepositoryProtocol {
